    ...
    <div className="newUser-home">
        ...
        <div className="categories-grid">
          <div className="category-card">
            ...
            <div className="category-info">
              <h3>Cardio</h3>
              <p>Boost your endurance and cardiovascular health with high-energy routines.</p>
            </div>
          </div>
          ...
          <div className="category-card">
            ...
            <div className="category-info">
              <h3>HIIT</h3>
              <p>Push your limits and burn calories fast with high-intensity interval training.</p>
            </div>
          </div>
          ...
          <div className="category-card">
            ...
            <div className="category-info">
              <h3>Yoga</h3>
              <p>Find balance, flexibility, and inner peace through mindful movements and poses.</p>
            </div>
          </div>
          ...
          <div className="category-card">
            ...
            <div className="category-info">
              ...
              <p>Build strength and tone your muscles with focused weightlifting exercises.</p>
            </div>
          </div>
          ...
          <div className="category-card">
            ...
            <div className="category-info">
              <h3>Pilates</h3>
              <p>Strengthen your core and enhance flexibility through mindful movements.</p>
            </div>
          </div>
          ...
          <div className="category-card">
            ...
            <div className="category-info">
              <h3>Meditation</h3>
              <p>Find your inner peace and calm your mind with guided relaxation techniques.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="info-bubbles">
        <div className="info-bubble">
          ...
          <p>Enjoy personalized fitness plans + access to top-notch equipment.</p>
        </div>
        <div className="info-bubble">
